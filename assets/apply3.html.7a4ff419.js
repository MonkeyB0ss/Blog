import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.8925ff20.js";const e={},p=t(`<h1 id="反射应用三-调用运行时类的指定结构" tabindex="-1"><a class="header-anchor" href="#反射应用三-调用运行时类的指定结构" aria-hidden="true">#</a> 反射应用三：调用运行时类的指定结构</h1><p>调用指定的属性：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
