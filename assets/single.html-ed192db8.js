...
<span class="token punctuation">}</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="两种方式的对比" tabindex="-1"><a class="header-anchor" href="#两种方式的对比" aria-hidden="true">#</a> 两种方式的对比</h3><div class="hint-container tip"><p class="hint-container-title">饿汉式</p><p><strong>坏处</strong>：对象加载时间过长。<br><strong>好处</strong>：饿汉式是线程安全的</p></div><div class="hint-container tip"><p class="hint-container-title">懒汉式</p><p><strong>好处</strong>：延迟对象的创建。<br> 目前的写法<strong>坏处</strong>：<mark>线程不安全</mark></p></div>`,17),c=[i];function p(l,o){return s(),a("div",null,c)}const r=n(t,[["render",p],["__file","single.html.vue"]]);export{r as default};
