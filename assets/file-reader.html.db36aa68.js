import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.1ee10b43.js";const e={},p=t(`<h1 id="节点流-或文件流" tabindex="-1"><a class="header-anchor" href="#节点流-或文件流" aria-hidden="true">#</a> 节点流（或文件流）</h1><h2 id="filereader-filewriter的使用" tabindex="-1"><a class="header-anchor" href="#filereader-filewriter的使用" aria-hidden="true">#</a> FileReader/FileWriter的使用</h2><h3 id="filereader的使用" tabindex="-1"><a class="header-anchor" href="#filereader的使用" aria-hidden="true">#</a> FileReader的使用</h3><p>将day09下的hello.txt文件内容读入程序中，并输出到控制台</p><div class="custom-container info"><p class="custom-container-title">说明点</p><ol><li><code>read()</code>的理解：返回读入的一个字符。如果达到文件末尾，返回-1</li><li>异常的处理：为了保证流资源一定可以执行关闭操作。需要使用<code>try-catch-finally</code>处理</li><li>读入的文件一定要存在，否则就会报<code>FileNotFoundException</code>。</li></ol></div><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
