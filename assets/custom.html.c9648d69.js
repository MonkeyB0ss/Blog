import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.c8c7e49e.js";const e="/Blog/assets/custom1.279bf922.png",p="/Blog/assets/custom2.8cc3563b.png",c={},o=t(`<h1 id="自定义泛型类、泛型接口、泛型方法" tabindex="-1"><a class="header-anchor" href="#自定义泛型类、泛型接口、泛型方法" aria-hidden="true">#</a> 自定义泛型类、泛型接口、泛型方法</h1><h2 id="order-java" tabindex="-1"><a class="header-anchor" href="#order-java" aria-hidden="true">#</a> Order.java</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Order</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">T</span><span class="token punctuation">&gt;</span></span> <span class="token punctuation">{</span>
